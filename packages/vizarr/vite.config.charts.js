...
if (process.env.GALAXY_ROOT) {
  ...
  console.log(
    "GALAXY_ROOT not available. Please provide as environment variable."
  );
}
...
if (process.env.GALAXY_KEY) {
  ...
  console.log(
    "GALAXY_KEY not available. Please provide as environment variable to access a remote Galaxy instance."
  );
}
