  ...
  <div class="tabbable">
    ...
    <div class="tab-content" id="top_level_tab_content">
          ...
          <div class='col-lg-12'>
            <div class="nav-trace">
              <div class="input-group input-group-sm" id='network_ui_bar' data-hivtrace-button-bar='yes'>
                ...
                <div class="input-group-btn">
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" data-hivtrace-ui-role="attributes_label">Color <span class="caret"></span></button>
                ...
                <div class="input-group-btn">
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" data-hivtrace-ui-role="shapes_label">Shape <span class="caret"></span></button>
                  <ul class="dropdown-menu" role="menu" data-hivtrace-ui-role='shapes'></ul>
                </div>
                <div class="input-group-btn">
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" data-hivtrace-ui-role="opacity_label">Opacity <span class="caret"></span></button>
                ...
                <div class="input-group input-group-sm">
                  ...
                  <span class="input-group-addon">Hide others <input type='checkbox' data-hivtrace-ui-role='hide_filter'></span>
                  <span class="input-group-addon">Show small clusters <input type='checkbox' data-hivtrace-ui-role='show_small_clusters'></span>
                  <span class="input-group-addon"><a data-toggle="collapse" href="#network_ui_bar_legend" aria-expanded="false" aria-controls="network_ui_bar_legend"><i class="fa fa-question"></i></a></span>
                </div>
              </div>
            </div>
            <div class="row collapse" id="network_ui_bar_legend" style="margin-top:0.1em" data-hivtrace="cluster-clone">
              <div class="well">
                ...
                <svg width="20" height="20" style="vertical-align:bottom; display:inline"><circle cx="10" cy="10" r="7" class='cluster'></circle></svg> with <em>area</em> proportional to the number of nodes in a cluster. Click on clusters to show menu options, click and drag to reposition.<p/>
                <span class="label label-primary">Nodes</span> are shown as different symbols with thin rims <svg width="20" height="20" style="vertical-align:bottom; display:inline"><circle cx="10" cy="10" r="7" class='node'></circle></svg> and <em>area</em> scaling with number of links.<p/>
              </div>
            </div>
            <div id='network_tag'>
              <div class="my_progress">
                <div class="progress-bar progress-bar-striped disabled" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%;height:50px">Loading the network</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="trace-graph" class="tab-pane">
        <div class='row'>
          <div class='col-lg-6'><p class="lead">Network Statistics</p><table class="table table-striped table-condensed table-responsive" id="graph_summary_table"></table></div>
          <div class='col-lg-6'><p id='histogram_label' class="lead"></p><div class='row' id='histogram_tag' style='margin-left:5px'></div></div>
        </div>
      </div>
      <div id="lanl-trace-results" class="tab-pane"><div class='row'><div class='col-lg-12'><div class="alert alert-info" id='lanl-main-warning' style='display:none;'></div></div></div></div>
      <div id="trace-clusters" class="tab-pane"><div class='row'><div class='col-lg-12'><span class="pull-right" id="cluster-table-export"></span><p class="lead">Clusters</p><table class="table table-striped table-condensed table-hover" id="cluster_table"></table></div></div></div>
      <div id="trace-nodes" class="tab-pane"><div class='row'><div class='col-lg-12'><span class="pull-right" id="node-table-export"></span><p class="lead">Linked individuals</p><table class="table table-striped table-condensed table-hover" id="node_table"></table></div></div></div>
      <div id="trace-attributes" class="tab-pane"></div>
    </div>
  </div>
</div>
