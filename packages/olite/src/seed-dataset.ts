/** Galaxy mounts olite as a visualization plugin, so a user can arrive with a dataset chosen.
 *
...
/** A one-line summary of the dataset olite was opened on, or null if there is nothing to say. */
export async function describeSeedDataset(
    ...
    try {
        ...
        console.warn("[olite] could not read the starting dataset", e);
        return null;
    }
}
