...
from olite.drivers.loop.galaxy_tools import _hda_inputs, _run_tool
...
def test_working_in_a_newly_created_history_is_allowed():
    """Targeting a different history than OLite is bound to is legal; ownership is what counts."""
