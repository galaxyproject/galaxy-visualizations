...
when_to_use: the user asks to visualize, chart, plot, graph, show, display or open a dataset, asks what a dataset can be displayed with, or asks to change a visualization or add a track to one
metadata:
  surfaces: [loom]
---
