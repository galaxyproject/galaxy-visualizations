    ...
    return (
        <>
            ...
            <p>
                ...
                <a href="https://github.com/GMOD/jbrowse-react-app-vite-demo" target="_blank" rel="noreferrer">
            ...
            <div>
                <p>
                    The button below will show you the current session, which includes things like what region the view
                    is showing and which tracks are open. This session JSON object can be used in the{" "}
