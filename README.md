...
This is a monorepo containing 48 individual visualization packages in the `packages/` directory. Each package is independently versioned and published to npm under the `@galaxyproject` scope.
